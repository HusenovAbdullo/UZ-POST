                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="signup__boxes round16 border">
                        ...
                        <form @submit.prevent="handleSubmit" class="write__review">
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    <div v-if="!codeVerified" class="frm__grp">
                                        ...
                                        <div style="display: flex; align-items: center;">
                                            ...
                                            <input v-model="smsCode" type="text" id="smsCode" placeholder="_ _ _ _"
                                                maxlength="4" class="form-control" style="width: 20%;" v-if="smsSent" />
                                        </div>
                                    ...
                                    <!-- Fake reCAPTCHA -->
                                    <div class="fake-recaptcha" v-if="!smsSent && !isRecovery">
                                ...
                                <div v-if="codeVerified" class="col-lg-12">
                                    <!-- <br>
                                    <div v-if="!isRecovery" class="frm__grp">
                                        ...
                                        <input v-model="name" type="text" id="nameInput"
                                            :placeholder="$t('enter_your_name')" class="form-control" />
                                    </div>
                                    <br> -->
                                    <div class="frm__grp">
                                ...
                                <!-- <p class="fz-16 fw-400 title inter">
                                    {{ isRecovery ? $t('remember_account') : $t('have_account1') }}
                                    <a href="signin" class="base">{{ $t('login') }}</a>
                                </p> -->
                                <!-- Tugma -->
...
export default {
    data() {
        return {
            isRecovery: false, // Rejimni aniqlash uchun holat
            phoneInput: "+998",
            smsCode: "",
            name: "",
            password: "",
    ...
    methods: {
        ...
        handleSmsRequest() {
            if (!this.isRecovery && !this.termsAccepted) {
                this.showPopup(this.$t('accept_terms'));
                return;
            }
            this.handleSubmit();
        },
        handleSubmit() {
            ...
            if (!this.smsSent) {
                axios.post(`https://new.pochta.uz/api/v1/public/${endpointPrefix}/1/`, { phone_number: phoneNumber })
                    .then(() => {
                        this.smsSent = true;
                        this.startTimer();
                    })
