<template>
   ...
   <section class="app__section ralt bg__all2 pb-120 pt-120">
            ...
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 wow fadeInDown">
               <div class="task__item round16 bgwhite d-flex align-items-center">
                  ...
                  <div class="content">
                     ...
                     <p class="fz-14 fw-400 inter pra mb-40">
                        "Bir Qadam" - bu O'zbekiston bo'ylab belgilangan bo'limlar orasida 1 KUN ichida yetkazib berish
                        xizmati.
                     </p>
                     <a href="freelancer-details.html" class="cmn--btn outline__btn">
                        <span>
            ...
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 wow fadeInUp">
               <div class="task__item round16 bgwhite d-flex align-items-center">
                  ...
                  <div class="content">
                     ...
                     <p class="fz-14 fw-400 inter pra mb-40">
                        Jo'natmalarni ixtiyoriy pochta bo'limidan O'zbekiston bo'ylab adresatlargacha yetkazib berish
                        xizmati
                     </p>
                     <a href="freelancer.html" class="cmn--btn outline__btn">
                        <span>
            ...
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 wow fadeInDown">
               <div class="task__item round16 bgwhite d-flex align-items-center">
                  ...
                  <div class="content">
                     ...
                     <p class="fz-14 fw-400 inter pra mb-40">
                        Ushbu xizmat jo'natmalarni butun dunyo bo'ylab 7-15 kun ichida yetkazib berish garovidir.
                     </p>
                     <br>
                     <a href="freelancer-details.html" class="cmn--btn outline__btn">
                        <span>
      ...
      <div class="text-center mt-40">
         <a href="yangiliklar.html" class="cmn--btn outline__btn">
            <span>
               Barcha xizmatlar
            </span>
            <span class="ps-1">
