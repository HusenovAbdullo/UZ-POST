            ...
            <div class="row g-4 align-items-center justify-content-between">
              <div class="col-xxl-6 col-xl-6 col-lg-7 col-md-7 col-sm-7">
                <div class="breadcumnd__content">
                  <span class="d41 mb-24">Markalar katalogi</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-xl-4 col-lg-4">
            <div class="card__sidebar side__sticky round16">
              <div class="card__common__item bgwhite round16">
                ...
                <form @submit.prevent="fetchMarks(1)" class="d-flex mb-24 filter__search align-items-center justify-content-between">
              ...
              <div class="row justify-content-center g-4">
                ...
                >
                  <div class="service__item shadow2 round16 p-8 bgwhite">
                    ...
                    >
                      <img
                        :src="mark.save_image_uz"
                        class="round16 w-100"
                        alt="service"
                      />
                    </router-link>
                    <h5 class="mt-24 mb-20">
                        <router-link :to="`/marka2/${mark.id}`" class="titley">
                            {{ mark.title_uz }}
                      </router-link>
                    </h5>
                    ...
                    <div class="d-flex align-items-center mt-20 justify-content-between">
                      ...
                      <router-link :to="`/marka2/${mark.id}`" class="aylana boxes1 round50 d-flex align-items-center justify-content-center">
