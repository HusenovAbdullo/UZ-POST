            ...
            <div class="row g-4 align-items-center justify-content-between">
              <div class="col-xxl-6 col-xl-6 col-lg-7 col-md-7 col-sm-7">
                <div class="breadcumnd__content">
                  <span class="d4 mb-24">Marka haqida</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-xl-4 col-lg-4">
            <div class="card__sidebar side__sticky round16" style="background: #0141a2;">
              <div class="card__common__item bgwhite round16">
                <span class="cateicon">
                  <img :src="marka.save_image_uz" alt="marka" style="width: 100%; height: 100%;" />
                </span>
              </div>
            </div>
          </div>
              ...
              <div class="tab-pane fade show active" role="tabpanel">
                <div class="overview__gitwrapper bgwhite round16 border">
                  ...
                  <div class="accordion-body" style="color: black;">
                    <p class="title2">Сhiqarilgan sana: {{ marka.years }}</p>
                    <p class="title2">Addadi: {{ marka.count_number }}</p>
                    <p class="title2">Nominal: {{ marka.price_uz }} so‘m</p>
                  </div>
                  <div class="divider">
                    <span>MARKA HAQIDA MA'LUMOT</span>
                  </div>
                  <p>{{ marka.description_uz }}</p>
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  async mounted() {
    try {
      ...
      // URL'ni HTTP'dan HTTPS'ga o'zgartirish
      const secureImageUrl = data.save_image_uz
        ? data.save_image_uz.replace("http://", "https://")
        : "default.jpg";

      // Ma'lumotlarni komponentga o'rnatish
      this.marka = {
        save_image_uz: secureImageUrl,
        title: data.title_uz || "Noma'lum",
