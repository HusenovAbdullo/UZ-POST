<template>
    ...
    <section class="categoris__section sectionbg pb-220 pt-22" style="background-color: #ffffff;">
        ...
        <div class="container">
            ...
            <teleport to="body">
                <div v-if="trackingData && isMobile" id="trackingPopup" class="popup" @click.self="closePopup">
                    <div class="popup-content">
                        <section class="task__sectiontop ralt pt-24 pb-12">
                            <button type="button" class="close-btn" @click.stop.prevent="closePopup"
                            ...
                            <div class="container">
                                <div class="row ralt g-4">
                                    ...
                                    <!-- Kuzatuv raqami -->
                                    <h2 class="title mb-20 text-center" id="trackingNumberDisplay">
                                        {{ trackingData.number }}
                                    </h2>

                                    <!-- Yuboruvchi -->
                                    <div v-if="trackingData.senderCountry" class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                        <div class="task__item round16 bgwhite d-flex align-items-center">
                                            <div class="thumb">
                                                <img src="https://uz.post/assets/img/bn/profile.png" alt="img">
                                            </div>
                                            <div class="content">
                                                <h3 class="inter title2 mb-16">{{ $t('sender') }}</h3>

                                                <p v-if="trackingData.senderCountry"
                                                    class="fz-16 fw-400 inter pra mb-8">
                                                    <strong>{{ $t('country') }}</strong><br>
                                                    <span class="textrang">{{ trackingData.senderCountry }}</span>
                                                </p>

                                                <p v-if="trackingData.senderAddress"
                                                    class="fz-16 fw-400 inter pra mb-8">
                                                    <strong>{{ $t('address5') }}</strong><br>
                                                    <span class="textrang">{{ trackingData.senderAddress }}</span>
                                                </p>

                                                <p v-if="trackingData.senderPostcode"
                                                    class="fz-16 fw-400 inter pra mb-0">
                                                    <strong>{{ $t('postal_code') }}</strong><br>
                                                    <span class="textrang">{{ trackingData.senderPostcode }}</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div v-if="trackingData.recipientCountry"
                                        ...
                                        <div class="task__item round16 bgwhite d-flex align-items-center">
                                            ...
                                            <div class="content">
                                                <h3 class="inter title2 mb-16">{{ $t('receiver') }}</h3>

                                                <p v-if="trackingData.recipientCountry"
                                                    class="fz-16 fw-400 inter pra mb-8">
                                                    <strong>{{ $t('country') }}</strong><br>
                                                    <span class="textrang">{{ trackingData.recipientCountry }}</span>
                                                </p>

                                                <p v-if="trackingData.recipientAddress"
                                                    class="fz-16 fw-400 inter pra mb-8">
                                                    <strong>{{ $t('address5') }}</strong><br>
                                                    <span class="textrang">{{ trackingData.recipientAddress }}</span>
                                                </p>

                                                <p v-if="trackingData.recipientPostcode"
                                                    class="fz-16 fw-400 inter pra mb-0">
                                                    <strong>{{ $t('postal_code') }}</strong><br>
                                                    <span class="textrang">{{ trackingData.recipientPostcode }}</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-12 col-lg-12">
                                        <div class="service__detailswrapper">
                                            <div class="trending__based mb-20 bgwhite round16 shadow1">
                                                <div class="based__content border round16 bgwhite">
                                                    <div class="freelancer__education bborderdash pb-16">
                                                        <h3 class="title2">{{ $t('kuzatuv') }}</h3>

                                                        <h4 v-if="trackingData.errorMessage" class="title mb-12 center"
                                                            style="color:red; font-size: 16px;">
                                                            {{ trackingData.errorMessage }}
                                                        </h4>

                                                        <ul class="blog__categories"
                                                            v-if="combinedTracking && combinedTracking.length">
                                                            <li v-for="(event, index) in combinedTracking" :key="index">
                                                                <a class="d-flex align-items-center">
                                                                    ...
                                                                    <span class="cateicon" v-if="event.country_code">
                                                                        <img :src="`https://uz.post/assets/img/flags/${String(event.country_code).toLowerCase()}.svg`"
                                                                    ...
                                                                    <span style="margin-left:8px;">
                                                                        <span
                                                                            class="fz-12 fw-500 inter success2 d-block">{{
                                                                                event.status }}</span>
                                                                        <span v-if="event.malumot"
                                                                            class="fz-10 fw-500 inter success2"
                                                                            style="color:brown; display:block; opacity:.7;">
                                                                            {{ event.malumot }}
                                                                        </span>
                                                                        <span v-if="event.malumot2"
                                                                            class="fz-10 fw-500 inter success2"
                                                                            style="color:brown; display:block; opacity:.7;">
                                                                            {{ event.malumot2 }}
                                                                        </span>
                                                        ...
                                                        <div v-else class="mt-2" style="opacity:.8">
                                                            {{ $t('no_data') || 'Maʼlumot topilmadi' }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <br>
            <br>
            <div class="row g-4 mb-40 justify-content-center">
                <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                    <div class="categoris__item round16 bgwhite border">
                        <div class="boxes  kat">
                            <div class="icon mb-24">
                                <img src="assets/img/categories/6.svg" alt="icon">
                            </div>
                            <div class="content">
                        ...
                        <router-link to="/map" class="d-flex readmore align-items-center gap-2">
                            ...
                            <span>
                                <i class="bi bi-arrow-right transition fz-18 base"></i>
                            </span>
                        </router-link>
                    </div>
                </div>
                <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                    <div class="categoris__item round16 bgwhite border">
                        <div class="boxes  kat">
                            <div class="icon mb-24 ">
                                <img src="assets/img/categories/1.svg" alt="icon">
                            </div>
                            <div class="content">
                                <h4 class="mb-10 title">
                                    {{ $t('news') }}
                        ...
                        <router-link to="/yangiliklar" class="d-flex readmore align-items-center gap-2">
                            <span class="fz-16 transition fw-600 base inter">
                                {{ $t('more_details') }}
                            </span>
                            <span>
                ...
                <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                    <div class="categoris__item round16 bgwhite border">
                        <div class="boxes  kat">
                            <div class="icon mb-24 ">
                                <img src="assets/img/categories/3.svg" alt="icon">
                            </div>
                            <div class="content">
                                <h4 class="mb-10 title">
                                    {{ $t('shipment_calculator') }}
                                </h4>
                            </div>
                        </div>
                ...
                <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                    <div class="categoris__item round16 bgwhite border">
                        <div class="boxes  kat">
                            <div class="icon mb-24 ">
                                <img src="assets/img/categories/2.svg" alt="icon">
                            </div>
                            <div class="content">
                                <h4 class="mb-10 title">
                ...
                <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                    <div class="categoris__item round16 bgwhite border">
                        <div class="boxes  kat">
                            <div class="icon mb-24 ">
                                <img src="assets/img/categories/4.svg" alt="icon">
                            </div>
                            <div class="content">
                                <h4 class="mb-10 title">
                                    {{ $t('my_post_index') }}
                ...
                <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                    <div class="categoris__item round16 bgwhite border">
                        <div class="boxes  kat">
                            <div class="icon mb-24 ">
                                <img src="assets/img/categories/5.svg" alt="icon">
                            </div>
                            <div class="content">
                                <h4 class="mb-10 title">
                                    {{ $t('send_inquiry') }}
                        ...
                        <router-link to="/aloqa" class="d-flex readmore align-items-center gap-2">
                            <span class="fz-16 transition fw-600 base inter">
                                {{ $t('more_details') }}
                            </span>
                            <span>
        ...
        <div class="container">
            <div class="perfoming__content">
                <div class="section__title mb-40">
                    ...
                    <h2 class="title2 mb-20 wow fadeInUp orta" data-wow-duration="1.2s">
                        {{ $t('about_multibrand_points') }}
                    </h2>
                    <br>
                    <p class="ptext2 fz-16 fw-400 inter wow fadeInUp orta" data-wow-duration="1.4s">
                        {{ $t('multibrand_points_description') }}
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="row row-cols-1 row-cols-md-2 g-4">
                    <div class="col wow fadeInDown">
                        <div class="perfoming__item d-flex">
                            <div
                                class="cmn__ibox transition d-flex align-items-center1 justify-content-center boxes1 round50">
                                <img src="assets/img/custom-icon/5.png" alt="machine">
                            </div>
                            <div class="content">
                                <p class="fz-14 fw-400 inter pra">
                                    {{ $t('multibrand_ordering') }}
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-xxl-6 col-xl-8 col-lg-8">
                    <div class="section__title ralt mb-40">
                        ...
                        <h2 class="title5 wow fadeInUp fz-32" data-wow-duration="1.2s">
                            Hamkor marketpleys va onlayn-do'konlar
                        </h2>
                        <p class="fz-18 fw-400 inter pra">
                            Sizni qiziqtirgan platformani tanlab, hamkorlik tafsilotlarini bilib olishingiz mumkin
                        </p>
                    </div>
                </div>
            </div>
            <div class="freelancer__wrapper owl-theme owl-carousel">
                <div class="frelancer__item shadow2 round16 bgwhite1">
                    <router-link to="/xizmat" class="thumb round16 boyi">
                        <img src="assets/img/uzum/uzum.png" class="round16 boyi" alt="service" style="width: 100%;">
                    </router-link>
                    <div class="d-flex pb-1 align-items-center justify-content-between">
                        <div class="d-flex fz-22 fw-400 gap-2 inter pra align-items-center title6" style="
                     font-size: 22px; color: #183E98;">
                            uzum.uz
                        </div>
                        <div class="d-flex fz-18 fw-400 gap-2 inter pra align-items-center">
                            Batafsil
                        </div>
                    </div>
                </div>
                <div class="frelancer__item shadow2 round16 bgwhite1">
                    <router-link to="/xizmat" class="thumb round16 boyi">
                        <img src="assets/img/uzum/xalq.png" class="round16 boyi" alt="service" style="width: 100%;">
                    </router-link>
                    <div class="d-flex pb-1 align-items-center justify-content-between">
                        <div class="d-flex fz-22 fw-400 gap-2 inter pra align-items-center title6" style="
                     font-size: 22px; color: #183E98;">
                ...
                <div class="frelancer__item shadow2 round16 bgwhite1">
                    <router-link to="/xizmat" class="thumb round16 boyi">
                        <img src="assets/img/uzum/zood.png" class="round16 boyi" alt="service" style="width: 100%;">
                    </router-link>
                    <div class="d-flex pb-1 align-items-center justify-content-between">
                        <div class="d-flex fz-22 fw-400 gap-2 inter pra align-items-center title6" style="
                     font-size: 22px; color: #183E98;">
                ...
                <div class="frelancer__item shadow2 round16 bgwhite1">
                    <router-link to="/xizmat" class="thumb round16 boyi">
                        <img src="assets/img/uzum/ali.png" class="round16 boyi" alt="service" style="width: 100%;">
                    </router-link>
                    <div class="d-flex pb-1 align-items-center justify-content-between">
                        <div class="d-flex fz-22 fw-400 gap-2 inter pra align-items-center title6" style="
                     font-size: 22px; color: #183E98;">
                ...
                <div class="col-xl-6 col-lg-7">
                    <div class="app__content">
                        <div class="section__title mb-30">
                            <h4 class="sub ralt title6 mb-16 wow fadeInDown">
                                {{ $t('download_app') }}
                            </h4>
                            <h2 class="title2 mb-40 wow fadeInUp">
                                {{ $t('app_description') }}
                            </h2>
                            <p class="ptext2 fz-18 fw-400 inter wow fadeInDown title7">
                                {{ $t('app_platforms') }}
                            </p>
                        </div>
                        <div class="app__store d-flex align-items-center gap-3 flex-wrap wow fadeInDown">
                            <a href="https://apps.apple.com/uz/app/uzpost/id1617774039">
                                <img src="assets/img/app/appstore.png" alt="app">
                            </a>
                            <a href="https://play.google.com/store/apps/details?id=com.uzpost.consumer&hl=uz&gl=US">
    ...
    <section class="app__section ralt bg__all pt-12">
        <div class="container">
            <div>
                <div>
                    <br>
                    <h3 class="fw-600 inter title2 bborderdash pb-24 mb-24">
                        <strong>{{ $t('faq') }}</strong>
                    </h3>
                    <div class="faq__qustion">
                        <div class="accordion__wrap">
                          ...
                          ">
                                            <p>
                                                {{ $t('tracking_instruction') }} {{ $t('tracking_code_format') }}
                                                ...
                                                <br>{{ $t('tracking_code_type_L') }}
                                                <br>{{ $t('tracking_code_type_E') }}
                                                <br>{{ $t('tracking_code_type_V') }}
                                                <br>{{ $t('tracking_code_type_A') }}
                                                <br>{{ $t('tracking_code_type_U') }}
                                                <br>{{ $t('tracking_code_type_Z') }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <!--Accordion items-->
                                <div class="accordion-item wow fadeInDown" data-wow-duration="1.1s">
                                    <h2 class="accordion-header" id="headingOner">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#collapseOner"
                                            aria-expanded="true" aria-controls="collapseOner" style="
                                 border-radius: 4px;
                                 border-top-left-radius: 4px;
                                 border-top-right-radius: 4px;
                                 border-bottom-right-radius: 4px;
                             ...
                             ">
                                    ...
                                    <div id="collapseOner" class="accordion-collapse collapse"
                                        aria-labelledby="headingOner" data-bs-parent="#accordionExample">
                                        <div class="accordion-body" style="
                              border-radius: 4px;
                              border-top-left-radius: 4px;
                              border-top-right-radius: 4px;
...
export default {
    ...
    methods: {
        ...
        // data() ichiga qo‘shing:
        // currentXhr: null,

        fetchTrackingData() {
            // Avvalgi so‘rovni bekor qilamiz (agar ochiq bo‘lsa)
            if (this.currentXhr) {
                try {
                    if (this.currentXhr.readyState !== 4) this.currentXhr.abort();
                } catch (err) {
                    // abort xatosi bo‘lsa ham davom etamiz (allaqachon tugagan bo‘lishi mumkin)
                    console.warn('Abort failed (ignored):', err);
                }
            ...
            if (!tn) {
                this.loading = false;
                this.errorMessage = this.$t?.('enter_tracking') || "Kuzatuv raqamini kiriting";
                return;
            }

            const prefix2 = tn.slice(0, 2);
            const isNewApi = (prefix2 === 'CZ' || prefix2 === 'RZ' || tn.startsWith('E'));
            const apiUrl = isNewApi
                ? `https://tracking.pochta.uz/api/v1/public/new/${encodeURIComponent(tn)}/`
                : `https://tracking.pochta.uz/api/v1/public/test/${encodeURIComponent(tn)}/`;
                    ...
                    if (xhr.status >= 200 && xhr.status < 300) {
                        ...
                        if (Array.isArray(data) && data.length > 0 && data[0]?.OperationalMailitems) {
                            ...
                            if (this.processEvents) {
                                this.processEvents(
                                    mailItem.Events?.TMailitemEventScanning || [],
                                    mailItem.DestCountry?.Code || 'UZ'
                                );
                            }
                        } else if (typeof this.processAlternativeData === 'function') {
                            this.processAlternativeData(data);
                        } else {
                            this.trackingData = {
                                number: tn,
                                errorMessage: this.$t?.('no_data') || "Ma'lumot topilmadi"
                            };
                            this.combinedTracking = [];
                        }
                        ...
                        this.errorMessage = (this.$t?.('server_response') || 'Server javobi') + ': ' + xhr.status;
                    }
                } catch (e) {
                    console.error(e);
                    this.errorMessage = this.$t?.('bad_response') || "Noto‘g‘ri javob formati";
                }
            };
            ...
            xhr.onerror = () => {
                ...
                this.loading = false;
                this.currentXhr = null;
                this.errorMessage = this.$t?.('network_error') || "So'rovni yuborishda xatolik yuz berdi";
            };
            ...
            xhr.ontimeout = () => {
                ...
                this.loading = false;
                this.currentXhr = null;
                this.errorMessage = this.$t?.('timeout') || "So‘rov vaqti tugadi";
            };
        ...
        // NEW: IPS formatidagi eventlarni yig‘ish
        ...
        // NEW: Temu/Shipox/Gdeposilka kabi alternativ javobni qayta ishlash
        processAlternativeData(data) {
            ...
            if (TemuList.length === 0) {
                this.combinedTracking =
                    new Date(sortedShipoxList[0]?.date || 0) > new Date(sortedGdeposilkaList[0]?.date || 0)
        ...
        getLocalizedStatus(data, forceLang) {
            ...
            if ('LocalName_uz' in data || 'LocalName_ru' in data || 'Name' in data) {
                ...
                return data.Name || 'Status noaniq';
            }
            if ('status_uz' in data || 'status_ru' in data || 'status_desc' in data) {
                if (lang === 'uz') return data.status_uz || data.status_desc || 'Status noaniq';
                if (lang === 'ru') return data.status_ru || data.status_desc || 'Status noaniq';
                return data.status_desc || 'Status noaniq';
            }
  ...
  document.body.classList.remove('no-scroll');
        ...
        async fetchPartnerLogos() {
            try {
                ...
                this.partnerLogos = response.data.filter(logo => logo.status);
            } catch (error) {
                console.error("Partner logotiplarini olishda xato: ", error);
            }
        },
        async fetchServices() {
            try {
    ...
    watch: {
        trackingData(val) {
            // scroll lock faqat mobil popup ochilganda
